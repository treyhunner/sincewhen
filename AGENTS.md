...
The one shape that is refused rather than answered is a name whose last presence is *in* 3.0 or 3.1, because reporting "removed in 3.2" would name a release two steps past where anyone stopped being able to use it, and nothing in the corpus needs the answer.
